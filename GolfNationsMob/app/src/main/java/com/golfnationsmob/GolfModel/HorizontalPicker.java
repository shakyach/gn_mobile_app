...
public class HorizontalPicker extends View {
    ...
    public void setHorizontalPickerButton(Button button) {
        mybuton = button;
       // mybuton.setX();
       // mybuton.setY(100);
    }

    public void setmyPicker(int picker)
    {
        mypicker = picker;
...
Context mycontext;
    ...
    public HorizontalPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        try {
            ...
            int setting =0;
            if(getScreenResolution(mycontext) == 480 )
            {
               setting = -15;
            }
            else
            if(getScreenResolution(mycontext) == 1440 || getScreenResolution(mycontext) == 1080)
            {
               setting = 40;
            }
            ...
            dividerSize = a.getDimension(R.styleable.HorizontalPicker_dividerSize, dividerSize)+setting;//+40;
           /* DisplayMetrics dm = getResources().getDisplayMetrics();
            float dpInPx = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 540/25, dm);
            Log.i("value","dpInPx =="+InBoxSize1);
            Log.i("value","dpInPx =="+dpInPx);
            dividerSize = (int)dpInPx;*/
            Log.i("value","density =="+getDeviceResolution());
...
Log.i("value","heightSize=="+heightSize);
Log.i("value","width=="+width);
        InBoxSize = heightSize;
        InBoxSize1 = width;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (values != null) {
            for (int i = 0; i < values.length; i++) {
                ...
                if(i== selectedItem)
                    textPaint.setColor(Color.parseColor("#10171f"));



                // get text layout
                BoringLayout layout = layouts[i];
                Log.i("value","layouts===="+i+"   "+layouts[i].getWidth());
               // layout.
                ...
                Log.i("value","lineWidth===="+lineWidth);
                Log.i("value","itemWidth===="+itemWidth);
                ...
                Log.i("value","x===="+x);
               // DisplayMetrics dm = getResources().getDisplayMetrics();
               // float dpInPx = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 24, dm);
                if(mypicker == 1) {
                    ...
                    if(i == 0)
                    {
                        ...
                        if(i== selectedItem)
                            ...
                            d = getResources().getDrawable(R.drawable.empty);
                        //   Drawable d = getResources().getDrawable(R.drawable.target_un);
                        d.setBounds(InBoxSize/6, InBoxSize/8, InBoxSize-InBoxSize/12, InBoxSize-InBoxSize/8);
                        d.draw(canvas);
                    }
                ...
                if(mypicker == 3) {
                    if(i == 0)
                    {
                        Drawable d;
                        if(i== selectedItem)
                            d = getResources().getDrawable(R.drawable.downlabeldark);
                        else
                            d = getResources().getDrawable(R.drawable.downlabel);
                        // Drawable d = getResources().getDrawable(R.drawable.downlabel);
                        d.setBounds(InBoxSize/6, InBoxSize/8, InBoxSize-InBoxSize/12, InBoxSize-InBoxSize/8);
                        d.draw(canvas);
                    }
                    else if(i == 1)
                    {
                        Drawable d;
                        if(i== selectedItem)
                            d = getResources().getDrawable(R.drawable.leftlabeldark);
                        else
                            d = getResources().getDrawable(R.drawable.leftlabel);
                        // Drawable d = getResources().getDrawable(R.drawable.leftlabel);
                        d.setBounds(InBoxSize/6, InBoxSize/8, InBoxSize-InBoxSize/12, InBoxSize-InBoxSize/8);
                        d.draw(canvas);
                    } else if(i == 2)
                    {
                    ...
                    else if(i == 3)
                    {
                        Drawable d;
                        if(i== selectedItem)
                            d = getResources().getDrawable(R.drawable.target_green);
                        else
                            d = getResources().getDrawable(R.drawable.target_un);
                        //   Drawable d = getResources().getDrawable(R.drawable.target_un);
                        d.setBounds(InBoxSize/6, InBoxSize/8, InBoxSize-InBoxSize/12, InBoxSize-InBoxSize/8);
                        d.draw(canvas);
                    }
                    else if(i == 4)
                    {
                        Drawable d;
                        if(i== selectedItem)
                            d = getResources().getDrawable(R.drawable.rightlabeldark);
                        else
                            d = getResources().getDrawable(R.drawable.rightlabel);
                        // Drawable d = getResources().getDrawable(R.drawable.rightlabel);
                        d.setBounds(InBoxSize/6, InBoxSize/8, InBoxSize-InBoxSize/12, InBoxSize-InBoxSize/8);
                        d.draw(canvas);
                    }
                    else if(i == 5)
                    {
                        Drawable d;
                        if(i== selectedItem)
                            d = getResources().getDrawable(R.drawable.uplabeldark);
                        else
                            d = getResources().getDrawable(R.drawable.uplabel);
                        // Drawable d = getResources().getDrawable(R.drawable.uplabel);
                        d.setBounds(InBoxSize/6, InBoxSize/8, InBoxSize-InBoxSize/12, InBoxSize-InBoxSize/8);
                        d.draw(canvas);
                    }
                    else
                ...
                if(mypicker == 0) {
                    if (i == 0) {
                        ...
                        Drawable d;
                        if(i== selectedItem)
                            d = getResources().getDrawable(R.drawable.round1dark);
                        else
                            d = getResources().getDrawable(R.drawable.round1);
                        d.setBounds(InBoxSize/6, InBoxSize/8, InBoxSize-InBoxSize/12, InBoxSize-InBoxSize/8);
                        d.draw(canvas);
                    } else if (i == 1) {
                        //  textPaint.setColor(Color.parseColor("#ffffff"));
                        Drawable d;
                        if(i== selectedItem)
                            d = getResources().getDrawable(R.drawable.round2dark);
                        else
                            d = getResources().getDrawable(R.drawable.round2);
                        d.setBounds(InBoxSize/6, InBoxSize/8, InBoxSize-InBoxSize/12, InBoxSize-InBoxSize/8);
                        d.draw(canvas);
                    }  else if (i == 2) {
                        //  textPaint.setColor(Color.parseColor("#ffffff"));
                        ...
                        Drawable d;
                        if(i== selectedItem)
                            d = getResources().getDrawable(R.drawable.square2dark);
                        else
                            d = getResources().getDrawable(R.drawable.square2);
                        d.setBounds(InBoxSize/6, InBoxSize/8, InBoxSize-InBoxSize/12, InBoxSize-InBoxSize/8);
                        d.draw(canvas);
                    }
                    else if (i == 5) {
                        ...
                        Drawable d;
                        if(i== selectedItem)
                            d = getResources().getDrawable(R.drawable.square1dark);
                        else
                            d = getResources().getDrawable(R.drawable.square1);
                        d.setBounds(InBoxSize/6, InBoxSize/8, InBoxSize-InBoxSize/12, InBoxSize-InBoxSize/8);
                        d.draw(canvas);
                    }
                    else if (i == 6) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if(scrollingX ||
                    ...
                    if(!scrollingX) {
                        ...
                        mybuton.setBackgroundResource(R.drawable.selector1);
    ...
    public void setSelectedItem(int index) {
        ...
        if(mypicker == 0) {
            if(getSelectedItem() != 2)
                mybuton.setBackgroundResource(R.drawable.selector);
            else
                mybuton.setBackgroundResource(R.drawable.selector1);
        }else if(mypicker == 2) {
    ...
    public void setValues(CharSequence[] values) {
        ...
        if (this.values != values) {
            ...
            if (this.values != null) {
                ...
                for (int i = 0; i < layouts.length; i++) {
                 //   Log.i("value of pick","i======="+"  "+this.values[i]);
...
//            postInvalidateOnAnimation(); // TODO
    ...
    private void finishScrolling() {
        ...
        adjustToNearestItemX();
        scrollingX = false;
        //Log.i("value","getSelectedItem()========================="+getSelectedItem());
        if(mypicker == 0) {
            if(getSelectedItem() != 2)
                mybuton.setBackgroundResource(R.drawable.selector);
            else
    ...
    {
        int density = mycontext.getResources().getDisplayMetrics().densityDpi;
        switch (density)
        {
